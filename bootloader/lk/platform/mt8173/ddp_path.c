...
unsigned int module_list_scenario[DDP_SCENARIO_MAX][DDP_ENING_NUM] = {
	...
	{DISP_MODULE_OVL0, DISP_MODULE_COLOR0, DISP_MODULE_AAL, DISP_MODULE_OD, DISP_MODULE_RDMA0, DISP_MODULE_UFOE, DISP_MODULE_PWM0, DISP_MODULE_DPI0, -1, -1},
#else
	...
	/*SUB_DISP      */
	{DISP_MODULE_OVL1,  DISP_MODULE_COLOR1, DISP_MODULE_GAMMA, DISP_MODULE_RDMA1, DISP_MODULE_DPI0, -1, -1, -1, -1, -1},
	/*SUB_RDMA1_DISP    */
	{DISP_MODULE_RDMA1, DISP_MODULE_DPI0, -1, -1, -1, -1, -1, -1, -1, -1},
	/*SUB_RDMA2_DISP    */
	{DISP_MODULE_RDMA2, DISP_MODULE_DSI0, -1, -1, -1, -1, -1, -1, -1, -1},
	/*SUB_OVL_MEMOUT    */
	...
	/*SUB_ALL       */
	{DISP_MODULE_OVL1,  DISP_MODULE_WDMA1, DISP_MODULE_COLOR1, DISP_MODULE_GAMMA, DISP_MODULE_RDMA1, DISP_MODULE_DPI0, -1, -1, -1, -1},
};
...
static mout_t mout_map[DDP_MOUT_NUM] = {
	...
	//GAMMA_MOUT
	{DISP_MODULE_GAMMA,  {{DISP_MODULE_RDMA1,1<<0},{DISP_MODULE_DSI0,1<<1},{DISP_MODULE_DSI1,1<<1}, {DISP_MODULE_DPI0,1<<1},{DISP_MODULE_WDMA1,1<<2},{-1,0}}, (volatile unsigned int*)DISP_REG_CONFIG_DISP_GAMMA_MOUT_EN,    0},
	// UFOE_MOUT
	{DISP_MODULE_UFOE,   {{DISP_MODULE_DSI0,1<<0}, {DISP_MODULE_SPLIT1,1<<1},{DISP_MODULE_DPI0,1<<2},{DISP_MODULE_WDMA0,1<<3},{-1,0}}, (volatile unsigned int*)DISP_REG_CONFIG_DISP_UFOE_MOUT_EN, 0},
};
...
static sel_t sel_out_map[DDP_SEL_OUT_NUM] = {
	...
	{DISP_MODULE_RDMA1,  {DISP_MODULE_DPI0, DISP_MODULE_COLOR1, -1}, (volatile unsigned int*)DISP_REG_CONFIG_DISP_RDMA1_SOUT_SEL_IN, 0},

	{DISP_MODULE_RDMA2,  {DISP_MODULE_DSI1, DISP_MODULE_DPI0, -1},   (volatile unsigned int*)DISP_REG_CONFIG_DISP_RDMA2_SOUT_SEL_IN, 0},
	...
	// DISP_PATH1_SOUT
	{DISP_MODULE_RDMA1,  {DISP_MODULE_DSI0, DISP_MODULE_DSI1, DISP_MODULE_DPI0, -1},  (volatile unsigned int*)DISP_REG_CONFIG_DISP_PATH1_SOUT_SEL_IN, 0},
	{DISP_MODULE_GAMMA,  {DISP_MODULE_DSI0, DISP_MODULE_DSI1, DISP_MODULE_DPI0, -1},  (volatile unsigned int*)DISP_REG_CONFIG_DISP_PATH1_SOUT_SEL_IN, 0},
	{DISP_MODULE_SPLIT0, {DISP_MODULE_DSI0, DISP_MODULE_DSI1, DISP_MODULE_DPI0, -1}, (volatile unsigned int*)DISP_REG_CONFIG_DISP_PATH1_SOUT_SEL_IN, 0},
};
...
static sel_t sel_in_map[DDP_SEL_IN_NUM] = {
	...
	{DISP_MODULE_DPI0, {DISP_MODULE_RDMA1, DISP_MODULE_GAMMA, DISP_MODULE_SPLIT0, -1}, (volatile unsigned int*)DISP_REG_CONFIG_DISP_PATH1_SEL_IN, 0},
	...
	//DPI0_SEL
	{DISP_MODULE_DPI0, {DISP_MODULE_UFOE, DISP_MODULE_RDMA1, DISP_MODULE_RDMA2, -1},    (volatile unsigned int*)DISP_REG_CONFIG_DPI_SEL_IN, 0},
	{DISP_MODULE_DPI0, {DISP_MODULE_UFOE, DISP_MODULE_GAMMA, DISP_MODULE_RDMA2, -1},    (volatile unsigned int*)DISP_REG_CONFIG_DPI_SEL_IN, 0},
	{DISP_MODULE_DPI0, {DISP_MODULE_UFOE, DISP_MODULE_SPLIT0, DISP_MODULE_RDMA2, -1},   (volatile unsigned int*)DISP_REG_CONFIG_DPI_SEL_IN, 0},
...
{
	return ddp_get_module_num_l((int *)module_list_scenario[scenario]);
}
...
int ddp_set_dst_module(DDP_SCENARIO_ENUM scenario, DISP_MODULE_ENUM dst_module)
{
	...
	i = ddp_get_module_num_l((int *)module_list_scenario[scenario])-1;
...
DISP_MODULE_ENUM ddp_get_dst_module(DDP_SCENARIO_ENUM ddp_scenario)
{
	DDPMSG("ddp_get_dst_module, scneario=%s, dst_module=%s \n",
	       ddp_get_scenario_name(ddp_scenario),
	       ddp_get_module_name(module_list_scenario[ddp_scenario][ddp_get_module_num_l((int *)module_list_scenario[ddp_scenario])-1]));

	return module_list_scenario[ddp_scenario][ddp_get_module_num_l((int *)module_list_scenario[ddp_scenario])-1];
}

int * ddp_get_scenario_list(DDP_SCENARIO_ENUM ddp_scenario)
{
	return (int *)module_list_scenario[ddp_scenario];
}
...
void ddp_connect_path(DDP_SCENARIO_ENUM scenario, void * handle)
{
	...
	if (scenario == DDP_SCENARIO_PRIMARY_ALL) {
		ddp_connect_path_l((int *)module_list_scenario[DDP_SCENARIO_PRIMARY_DISP], handle);
		ddp_connect_path_l((int *)module_list_scenario[DDP_SCENARIO_PRIMARY_OVL_MEMOUT],handle);
	} else if (scenario == DDP_SCENARIO_SUB_ALL) {
		ddp_connect_path_l((int *)module_list_scenario[DDP_SCENARIO_SUB_DISP], handle);
		ddp_connect_path_l((int *)module_list_scenario[DDP_SCENARIO_SUB_OVL_MEMOUT], handle);
	} else if (scenario == DDP_SCENARIO_RDMA0_DUAL_DISP) {
		ddp_set_dst_module(scenario,DISP_MODULE_DSI0);
		ddp_connect_path_l((int *)module_list_scenario[scenario], handle);
...
void ddp_disconnect_path(DDP_SCENARIO_ENUM scenario,void * handle)
{
	...
	if (scenario == DDP_SCENARIO_PRIMARY_ALL) {
		ddp_disconnect_path_l((int *)module_list_scenario[DDP_SCENARIO_PRIMARY_DISP], handle);
		ddp_disconnect_path_l((int *)module_list_scenario[DDP_SCENARIO_PRIMARY_OVL_MEMOUT], handle);
	} else if (scenario == DDP_SCENARIO_SUB_ALL) {
		ddp_disconnect_path_l((int *)module_list_scenario[DDP_SCENARIO_SUB_DISP], handle);
		ddp_disconnect_path_l((int *)module_list_scenario[DDP_SCENARIO_SUB_OVL_MEMOUT], handle);
	} else if (scenario == DDP_SCENARIO_RDMA0_DUAL_DISP) {
		ddp_set_dst_module(scenario,DISP_MODULE_DSI0);
		ddp_disconnect_path_l((int *)module_list_scenario[scenario], handle);
		ddp_set_dst_module(scenario,DISP_MODULE_DSI1);
		ddp_disconnect_path_l((int *)module_list_scenario[scenario], handle);
		ddp_set_dst_module(scenario,DISP_MODULE_DSIDUAL);
	} else {
...
void ddp_check_path(DDP_SCENARIO_ENUM scenario)
{
	...
	if (scenario == DDP_SCENARIO_PRIMARY_ALL) {
		ddp_check_path_l((int *)module_list_scenario[DDP_SCENARIO_PRIMARY_DISP]);
		ddp_check_path_l((int *)module_list_scenario[DDP_SCENARIO_PRIMARY_OVL_MEMOUT]);
	} else if (scenario == DDP_SCENARIO_SUB_ALL) {
		ddp_check_path_l((int *)module_list_scenario[DDP_SCENARIO_SUB_DISP]);
		ddp_check_path_l((int *)module_list_scenario[DDP_SCENARIO_SUB_OVL_MEMOUT]);
	} else if (scenario == DDP_SCENARIO_RDMA0_DUAL_DISP) {
		ddp_set_dst_module(scenario,DISP_MODULE_DSI0);
		ddp_check_path_l((int *)module_list_scenario[scenario]);
		ddp_set_dst_module(scenario,DISP_MODULE_DSI1);
		ddp_check_path_l((int *)module_list_scenario[scenario]);
		ddp_set_dst_module(scenario,DISP_MODULE_DSIDUAL);
	} else {
...
void ddp_check_mutex(int mutex_id, DDP_SCENARIO_ENUM scenario, DDP_MODE mode)
{
	DDPDBG("check mutex %d on scenario %s\n",mutex_id,
	       ddp_get_scenario_name(scenario));
	ddp_check_mutex_l(mutex_id,(int *)module_list_scenario[scenario],mode);
	return ;
}

int ddp_mutex_set(int mutex_id,DDP_SCENARIO_ENUM scenario,DDP_MODE mode, void * handle)
{
	return ddp_mutex_set_l(mutex_id, (int *)module_list_scenario[scenario],mode, handle);
}
...
#if HDMI_SUB_PATH_LK
	ddp_enable_module_clock(DISP_MODULE_LARB4); // sub path ovl1 access dram
#endif
...
#if HDMI_SUB_PATH_LK
	ddp_disable_module_clock(DISP_MODULE_LARB4); // sub path ovl1 access dram
#endif
	DDPMSG("ddp CG0:%x CG1:%x\n", DISP_REG_GET(DISP_REG_CONFIG_MMSYS_CG_CON0),
	       DISP_REG_GET(DISP_REG_CONFIG_MMSYS_CG_CON1));
