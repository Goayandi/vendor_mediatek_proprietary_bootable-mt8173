...
#define GPT_ENTRIES_NUM_OFFSET		0x50
#define GPT_ENTRY_SIZE_OFFSET		0x54
#define GPT_ENTRIES_LBA				2
#define GPT_ENTRY_NAME_OFFSET		0x38
#define GPT_ENTRY_FST_LBA_OFFSET	0x20
#define GPT_ENTRY_LST_LBA_OFFSET	0x28
#
...
extern int read_fastlogo_info(void *data);
extern int part_read(char *part_name, signed offset, u32 size, void *outBuf);
extern int part_write(char *part_name, signed offset, u32 size, void *inBuf);

extern int part_read_dramc(u32 offset_in_blk, u32 size_in_blk, u8 *buf);
extern int part_write_dramc(u32 offset_in_blk, u32 size_in_blk, u8 *buf);
