...
CFG_RTC_REG_EMERGENCY_DL_SUPPORT := 0
...
ONEKEY_REBOOT_NORMAL_MODE_PL :=3
KPD_PMIC_LPRST_TD :=3
MTK_PMIC_RST_KEY :=
...
CFG_BOOTIMG_HEADER_MEMADDR   :=0x00100800
CFG_ATF_SUPPORT :=1
CFG_ATF_LOG_SUPPORT :=1
CFG_TEE_SUPPORT :=0
CFG_MTK_IN_HOUSE_TEE_SUPPORT :=0
#CFG_NON_SECURE_SRAM_ADDR :=0x00130000
CFG_NON_SECURE_SRAM_ADDR :=0x0012FB00
#CFG_NON_SECURE_SRAM_SIZE :=0x0
CFG_NON_SECURE_SRAM_SIZE :=0x500
