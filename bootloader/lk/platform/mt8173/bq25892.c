 ...
 *
 **********************************************************/
#if defined(MTK_BQ25892_SUPPORT)//BQ25892
...
CHARGER_TYPE bq25892_charger_type_detection(void)
{
	...
	bq25892_print("[LK] use BQ25892 charger detection\r\n");
...
{
	bq25892_set_ichg((cc_value/64) & 0x7F);
}
...
static void bq_set_input_current_limit(kal_int32 input_limit)
{
	switch (input_limit) {
		case 500:
			bq25892_set_iinlim(0x8);
			break;
		case 2000:
			bq25892_set_iinlim(0x26);
			break;
		default:
			bq25892_set_iinlim(0x8);
	}
...
static void bq_set_reg_voltage(kal_int32 cv)
{
	if (cv == 4200)
		...
		bq25892_set_vreg(0x0A); //VREG 4.0V
	else
		bq25892_set_vreg(0x17); //VREG 4.208V
}
...
static void register_charger_control(void)
{
	...
	/* BQ25892 supports BC1.2 */
#if defined(MTK_BQ25892_SUPPORT)
	charger.charger_type_detection = bq25892_charger_type_detection;
#endif
}

void probe_bq25892(void)
{
	if (bq25892_get_pn() == 0x2 || bq25892_get_pn() == 0x0) {
		register_charger_control();
		bq25892_print("find BQ25892/BQ25896 device and register charger control.\n");
	} else
		bq25892_print("no BQ25892 device is found.\n");
