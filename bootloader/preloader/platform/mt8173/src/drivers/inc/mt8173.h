...
#define CA7MCUCFG_BASE      (IO_PHYS + 0x200100)
#define CA15L_CONFIG_BASE   (IO_PHYS + 0x200200)
...
#define SPI_BASE            (IO_PHYS + 0x0100A000)  /* FIXME */
...
#define USBSIF_BASE         (IO_PHYS + 0x01210000)  //REMOVING
...
#define USB_SIF_BASE				        (IO_PHYS + 0x01280000)
#define SSUSB_SIFSLV_IPPC_BASE			    (USB_SIF_BASE + 0x700)

#define USB_SIF2_BASE				        (IO_PHYS + 0x01290000)
#define SSUSB_SIFSLV_SPLLC_BASE             (USB_SIF2_BASE + 0x000)
#define SSUSB_SIFSLV_U2PHY_COM_BASE		    (USB_SIF2_BASE + 0x800)
#define SSUSB_SIFSLV_U2PHY_COM_SIV_B_BASE	(USB_SIF2_BASE + 0x800)
