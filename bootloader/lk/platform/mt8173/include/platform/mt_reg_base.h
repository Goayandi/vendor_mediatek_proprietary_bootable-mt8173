...
// APB Module irda
#define IRDA_FRAMER_BASE (0x1100C000)
...
// APB Module ovl
#define OVL1_BASE (0x1400d000)

// APB Module disp_rdma
#define DISP_RDMA0_BASE (0x1400e000)

// APB Module disp_rdma
#define DISP_RDMA1_BASE (0x1400f000)

// APB Module disp_rdma
#define DISP_RDMA2_BASE (0x14010000)
...
// APB Module merge
#define DISP_MERGE_BASE (0x14017000)

// APB Module split
#define DISP_SPLIT0_BASE (0x14018000)

// APB Module split
#define DISP_SPLIT1_BASE (0x14019000)

// APB Module disp_ufoe_config
#define DISP_UFOE_BASE (0x1401a000)

// APB Module dsi
#define DSI0_BASE (0x1401b000)

// APB Module dsi
#define DSI1_BASE (0x1401c000)

// APB Module disp_dpi
#define DPI0_BASE (0x1401d000)

// APB Module disp_dpi
#define DPI1_BASE (0x14024000)

// APB Module disp_pwm
#define DISP_PWM0_BASE (0x1401e000)

// APB Module disp_pwm
#define DISP_PWM1_BASE (0x1401f000)

// APB Module disp_mutex
#define MM_MUTEX_BASE (0x14020000)

// APB Module smi_larb
#define SMI_LARB0_BASE (0x14021000)

// APB Module smi
#define SMI_COMMON_BASE (0x14022000)

// APB Module disp_od
#define DISP_OD_BASE (0x14023000)
...
#define CFG_BOOTARGS_ADDR               (DRAM_PHY_ADDR + 0x300)

/*Command passing to Kernel */
#ifdef MACH_FPGA
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT0,921600n1 root=/dev/ram console=ttyS0,921600n1"
#else
#define COMMANDLINE_TO_KERNEL  "console=tty0 console=ttyMT3,921600n1 root=/dev/ram console=ttyS0,921600n1 androidboot.hardware=mt8173"
#endif
#define CFG_FACTORY_NAME    "factory.img"
#define DKERNEL_NAME           "dkernel"
