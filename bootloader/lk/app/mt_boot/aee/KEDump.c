...
static struct aee_db_file_info adfi[AEE_PLAT_DEBUG_NUM] = {
	...
	[AEE_PLAT_ATF_LAST_LOG] = { "SYS_ATF_LAST", 0x8000 }, /* 32KB */
	[AEE_PLAT_ATF_CRASH_REPORT] = { "SYS_ATF_CRASH", 0x18000 }, /* 64KB+32KB */
	[AEE_PLAT_ATF_RAW_LOG] = { "SYS_ATF_RAW_LOG", 0x40000 } /* 256 KB */
};
