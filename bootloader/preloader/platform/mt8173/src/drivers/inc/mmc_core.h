...
/* BOOT_WP_STATUS[174] */
#define EXT_CSD_BOOT_WP_STATUS_B1_WP    (2)
#define EXT_CSD_BOOT_WP_STATUS_B2_WP    (2 << 2)
...
enum mmc_boot_wp_type {
	MMC_BOOT_WP_B1_PWRON,
	MMC_BOOT_WP_B1_PERM,
	MMC_BOOT_WP_B2_PWRON,
	MMC_BOOT_WP_B2_PERM,
	MMC_BOOT_WP_B12_PWRON,
	MMC_BOOT_WP_B12_PERM,
	MMC_BOOT_WP_NONE
};

#define MMC_EXT_CSD_BOOT_WP_B1_PERM		0xC4
#define MMC_EXT_CSD_BOOT_WP_B1_PWRON	0x91
#define MMC_EXT_CSD_BOOT_WP_B2_PERM		0xCC
#define MMC_EXT_CSD_BOOT_WP_B2_PWRON	0x99
#define MMC_EXT_CSD_BOOT_WP_B12_PERM	0x44
#define MMC_EXT_CSD_BOOT_WP_B12_PWRON	0x11
#define MMC_EXT_CSD_BOOT_WP_NONE		0x50
...
extern void mmc_convert_dma_mode(int id);
#endif
