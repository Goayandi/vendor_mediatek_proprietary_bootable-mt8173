...
//==============================
//dram debug use
#define DRAMC_DEBUG_LOG_LEVEL	//support the different log level
#define DRAMC_DEBUG_TIME		//calculate dram calibration time
//#define DRAMC_DEBUG_RETRY		//retry dram init and calibartion 3times when memory test fail
//#define DRAMC_DEBUG_SELFREFRESH //dram self-refresh test code
//#define DRAMC_DEBUG_FULL_MEMORY_SCAN 
//#define DRAMC_DEBUG_TEST_MENU   //need open preloader log
#ifdef DRAMC_DEBUG_TEST_MENU
//#define DRAMC_DEBUG_TEST_MENU_FREQ	//dram test menu support adjust dram freq
#endif

#ifdef DDR_LOG_SAVEIN_EMMC
#define DRAMC_DEBUG_CALIB_LOG   //save calibration result in eMMC partition
#endif
//==============================
//Feature option
...
#ifdef MT8173_BOX_P1V1   //for bx8173p1v1
#define DDR_1333
#else
#define DDR_1792
#endif
...
#define DUAL_FREQ_LOW	533		// 1066 Mbps
    ...
    #define DUAL_FREQ_HIGH  933     // 1333 <-> 1866 Mbps
