...
extern int ufs_aio_blkdev_read(ufs_aio_blkdev_t *bdev, uint64 src, uint64 size, u8 *dst, u8 lun);
extern int ufs_aio_blkdev_write(ufs_aio_blkdev_t *bdev, uint64 dst, uint64 size, u8 *src, u8 lun);
