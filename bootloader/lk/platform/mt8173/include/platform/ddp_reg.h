...
#define DDP_REG_BASE_DPI1          DPI1_BASE          //0xf4024000
...
#define MIPI_TX0_REG_BASE               0x10215000
#define MIPI_TX1_REG_BASE               0x10216000
#define DDP_REG_BASE_MMSYS_CONFIG2 0x10206000
#define DDP_REG_BASE_MMSYS_CONFIG3 0x10000000
#define DDP_REG_IO_DRIVING          0x100020F0
#define DDP_REG_TVDPLL_CON6         0x100000A0
#define DDP_REG_TVDPLL_CON0         0x1000C270
#define DDP_REG_TVDPLL_CON1         0x1000C274


#define DISPSYS_REG_ADDR_MIN 0x14000000
#define DISPSYS_REG_ADDR_MAX 0x14025000
...
#define MMSYS_CG_FLD_CG0_MUTEX_32K                             REG_FLD(1, 15)
#define MMSYS_CG_FLD_CG0_OVL0                                  REG_FLD(1, 16)
#define MMSYS_CG_FLD_CG0_OVL1                                  REG_FLD(1, 17)
#define MMSYS_CG_FLD_CG0_RDMA0                                 REG_FLD(1, 18)
#define MMSYS_CG_FLD_CG0_RDMA1                                 REG_FLD(1, 19)
#define MMSYS_CG_FLD_CG0_RDMA2                                 REG_FLD(1, 20)
...
#define MMSYS_CG_FLD_CG0_COLOR1                                REG_FLD(1, 24)
#define MMSYS_CG_FLD_CG0_AAL                                   REG_FLD(1, 25)
#define MMSYS_CG_FLD_CG0_GAMMA                                 REG_FLD(1, 26)
#define MMSYS_CG_FLD_CG0_UFOE                                  REG_FLD(1, 27)
#define MMSYS_CG_FLD_CG0_SPLIT0                                REG_FLD(1, 28)
#define MMSYS_CG_FLD_CG0_SPLIT1                                REG_FLD(1, 29)
#define MMSYS_CG_FLD_CG0_MERGE                                 REG_FLD(1, 30)
#define MMSYS_CG_FLD_CG0_OD                                    REG_FLD(1, 31)

#define MMSYS_CG_FLD_CG1_PWM0_MM                               REG_FLD(1, 0)
#define MMSYS_CG_FLD_CG1_PWM0_26M                              REG_FLD(1, 1)
#define MMSYS_CG_FLD_CG1_PWM1_MM                               REG_FLD(1, 2)
#define MMSYS_CG_FLD_CG1_PWM1_26M                              REG_FLD(1, 3)
#define MMSYS_CG_FLD_CG1_DSI0_ENG                              REG_FLD(1, 4)
#define MMSYS_CG_FLD_CG1_DSI0_DIG                              REG_FLD(1, 5)
#define MMSYS_CG_FLD_CG1_DSI1_ENG                              REG_FLD(1, 6)
#define MMSYS_CG_FLD_CG1_DSI1_DIG                              REG_FLD(1, 7)
#define MMSYS_CG_FLD_CG1_DPI_PIX                               REG_FLD(1, 8)
#define MMSYS_CG_FLD_CG1_DPI_ENG                               REG_FLD(1, 9)
#define MMSYS_CG_FLD_CG1_SMI_LARB4                             REG_FLD(1, 18)
...
#define DISP_REG_OVL_RDMA0_MEM_GMC_SETTING2             (DISPSYS_OVL0_BASE + 0x1E0)
#define DISP_REG_OVL_RDMA1_MEM_GMC_SETTING2             (DISPSYS_OVL0_BASE + 0x1E4)
#define DISP_REG_OVL_RDMA2_MEM_GMC_SETTING2             (DISPSYS_OVL0_BASE + 0x1E8)
#define DISP_REG_OVL_RDMA3_MEM_GMC_SETTING2             (DISPSYS_OVL0_BASE + 0x1EC)
...
#define L0_CON_FLD_HORIZONTAL_FLIP_EN                       REG_FLD(1, 10)
#define L0_CON_FLD_VERTICAL_FLIP_EN                             REG_FLD(1, 9)
...
#define L0_PITCH_FLD_SURFL_EN                                       REG_FLD(1, 31)
#define L0_PITCH_FLD_L0_DRGB_SEL                                REG_FLD(2, 22)
#define L0_PITCH_FLD_L0_DA_SEL                                  REG_FLD(2, 20)
#define L0_PITCH_FLD_L0_SRGB_SEL                                REG_FLD(2, 18)
#define L0_PITCH_FLD_L0_SA_SEL                                      REG_FLD(2, 16)
#define L0_PITCH_FLD_L0_SRC_PITCH                               REG_FLD(16, 0)
#define L0_TILE_FLD_TILE_HORI_BLOCK_NUM                     REG_FLD(8, 24)
#define L0_TILE_FLD_TILE_EN                                         REG_FLD(1, 21)
#define L0_TILE_FLD_TILE_WIDTH_SEL                              REG_FLD(1, 20)
#define L0_TILE_FLD_TILE_HEIGHT                                 REG_FLD(20, 0)
...
#define L1_CON_FLD_HORIZONTAL_FLIP_EN                       REG_FLD(1, 10)
#define L1_CON_FLD_VERTICAL_FLIP_EN                             REG_FLD(1, 9)
...
#define L1_PITCH_FLD_SURFL_EN                                       REG_FLD(1, 31)
#define L1_PITCH_FLD_L1_DRGB_SEL                                REG_FLD(2, 22)
#define L1_PITCH_FLD_L1_DA_SEL                                  REG_FLD(2, 20)
#define L1_PITCH_FLD_L1_SRGB_SEL                                REG_FLD(2, 18)
#define L1_PITCH_FLD_L1_SA_SEL                                  REG_FLD(2, 16)
#define L1_PITCH_FLD_L1_SRC_PITCH                               REG_FLD(16, 0)
#define L1_TILE_FLD_TILE_HORI_BLOCK_NUM                     REG_FLD(8, 24)
#define L1_TILE_FLD_TILE_EN                                         REG_FLD(1, 21)
#define L1_TILE_FLD_TILE_WIDTH_SEL                              REG_FLD(1, 20)
#define L1_TILE_FLD_TILE_HEIGHT                                 REG_FLD(20, 0)
...
#define L2_CON_FLD_HORIZONTAL_FLIP_EN                       REG_FLD(1, 10)
#define L2_CON_FLD_VERTICAL_FLIP_EN                             REG_FLD(1, 9)
...
#define L2_PITCH_FLD_SURFL_EN                                       REG_FLD(1, 31)
#define L2_PITCH_FLD_L2_DRGB_SEL                                REG_FLD(2, 22)
#define L2_PITCH_FLD_L2_DA_SEL                                  REG_FLD(2, 20)
#define L2_PITCH_FLD_L2_SRGB_SEL                                REG_FLD(2, 18)
#define L2_PITCH_FLD_L2_SA_SEL                                  REG_FLD(2, 16)
#define L2_PITCH_FLD_L2_SRC_PITCH                               REG_FLD(16, 0)
#define L2_TILE_FLD_TILE_HORI_BLOCK_NUM                     REG_FLD(8, 24)
#define L2_TILE_FLD_TILE_EN                                         REG_FLD(1, 21)
#define L2_TILE_FLD_TILE_WIDTH_SEL                              REG_FLD(1, 20)
#define L2_TILE_FLD_TILE_HEIGHT                                 REG_FLD(20, 0)
...
#define L3_CON_FLD_HORIZONTAL_FLIP_EN                       REG_FLD(1, 10)
#define L3_CON_FLD_VERTICAL_FLIP_EN                             REG_FLD(1, 9)
...
#define L3_PITCH_FLD_SURFL_EN                                       REG_FLD(1, 31)
#define L3_PITCH_FLD_L3_DRGB_SEL                                REG_FLD(2, 22)
#define L3_PITCH_FLD_L3_DA_SEL                                  REG_FLD(2, 20)
#define L3_PITCH_FLD_L3_SRGB_SEL                                REG_FLD(2, 18)
#define L3_PITCH_FLD_L3_SA_SEL                                  REG_FLD(2, 16)
#define L3_PITCH_FLD_L3_SRC_PITCH                               REG_FLD(16, 0)
#define L3_TILE_FLD_TILE_HORI_BLOCK_NUM                     REG_FLD(8, 24)
#define L3_TILE_FLD_TILE_EN                                         REG_FLD(1, 21)
#define L3_TILE_FLD_TILE_WIDTH_SEL                              REG_FLD(1, 20)
#define L3_TILE_FLD_TILE_HEIGHT                                 REG_FLD(20, 0)

#define RDMA0_CTRL_FLD_RDMA0_FIFO_MIN_DEPTH                                     REG_FLD(11, 16)
#define RDMA0_CTRL_FLD_RDMA0_INTERLACE                                                  REG_FLD(1, 4)
#define RDMA0_CTRL_FLD_RDMA0_EN                                                             REG_FLD(1, 0)
#define RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_PRE_ULTRA_THRESHOLD_HIGH_OFS   REG_FLD(8, 24)
#define RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_ULTRA_THRESHOLD_HIGH_OFS           REG_FLD(8, 16)
#define RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_PRE_ULTRA_THRESHOLD_LOW_OFS        REG_FLD(8, 8)
#define RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_ULTRA_THRESHOLD_LOW                REG_FLD(8, 0)
...
#define RDMA1_CTRL_FLD_RDMA1_FIFO_MIN_DEPTH                                         REG_FLD(11, 16)
#define RDMA1_CTRL_FLD_RDMA1_INTERLACE                                                  REG_FLD(1, 4)
#define RDMA1_CTRL_FLD_RDMA1_EN                                                             REG_FLD(1, 0)
#define RDMA1_MEM_GMC_SETTING1_FLD_RDMA1_PRE_ULTRA_THRESHOLD_HIGH_OFS   REG_FLD(8, 24)
#define RDMA1_MEM_GMC_SETTING1_FLD_RDMA1_ULTRA_THRESHOLD_HIGH_OFS           REG_FLD(8, 16)
#define RDMA1_MEM_GMC_SETTING1_FLD_RDMA1_PRE_ULTRA_THRESHOLD_LOW_OFS        REG_FLD(8, 8)
#define RDMA1_MEM_GMC_SETTING1_FLD_RDMA1_ULTRA_THRESHOLD_LOW                REG_FLD(8, 0)
...
#define RDMA2_CTRL_FLD_RDMA2_FIFO_MIN_DEPTH                                         REG_FLD(11, 16)
#define RDMA2_CTRL_FLD_RDMA2_INTERLACE                                                  REG_FLD(1, 4)
#define RDMA2_CTRL_FLD_RDMA2_EN                                                             REG_FLD(1, 0)
#define RDMA2_MEM_GMC_SETTING1_FLD_RDMA2_PRE_ULTRA_THRESHOLD_HIGH_OFS   REG_FLD(8, 24)
#define RDMA2_MEM_GMC_SETTING1_FLD_RDMA2_ULTRA_THRESHOLD_HIGH_OFS           REG_FLD(8, 16)
#define RDMA2_MEM_GMC_SETTING1_FLD_RDMA2_PRE_ULTRA_THRESHOLD_LOW_OFS        REG_FLD(8, 8)
#define RDMA2_MEM_GMC_SETTING1_FLD_RDMA2_ULTRA_THRESHOLD_LOW                REG_FLD(8, 0)
...
#define RDMA3_CTRL_FLD_RDMA3_FIFO_MIN_DEPTH                                         REG_FLD(11, 16)
#define RDMA3_CTRL_FLD_RDMA3_INTERLACE                                                  REG_FLD(1, 4)
#define RDMA3_CTRL_FLD_RDMA3_EN                                                             REG_FLD(1, 0)
#define RDMA3_MEM_GMC_SETTING1_FLD_RDMA3_PRE_ULTRA_THRESHOLD_HIGH_OFS   REG_FLD(8, 24)
#define RDMA3_MEM_GMC_SETTING1_FLD_RDMA3_ULTRA_THRESHOLD_HIGH_OFS           REG_FLD(8, 16)
#define RDMA3_MEM_GMC_SETTING1_FLD_RDMA3_PRE_ULTRA_THRESHOLD_LOW_OFS        REG_FLD(8, 8)
#define RDMA3_MEM_GMC_SETTING1_FLD_RDMA3_ULTRA_THRESHOLD_LOW                REG_FLD(8, 0)
...
#define L0_Y2R_PARA_YUV_A_0_FLD_C_CF_UA                 REG_FLD(9, 16)
#define L0_Y2R_PARA_YUV_A_0_FLD_C_CF_YA             REG_FLD(9, 0)
#define L0_Y2R_PARA_YUV_A_1_FLD_C_CF_VA                 REG_FLD(9, 0)
#define L0_Y2R_PARA_RGB_A_0_FLD_C_CF_GA                 REG_FLD(9, 16)
...
#define L1_Y2R_PARA_YUV_A_0_FLD_C_CF_UA             REG_FLD(9, 16)
#define L1_Y2R_PARA_YUV_A_0_FLD_C_CF_YA                 REG_FLD(9, 0)
#define L1_Y2R_PARA_YUV_A_1_FLD_C_CF_VA                 REG_FLD(9, 0)
#define L1_Y2R_PARA_RGB_A_0_FLD_C_CF_GA             REG_FLD(9, 16)
...
#define L2_Y2R_PARA_YUV_A_0_FLD_C_CF_UA                 REG_FLD(9, 16)
#define L2_Y2R_PARA_YUV_A_0_FLD_C_CF_YA                 REG_FLD(9, 0)
#define L2_Y2R_PARA_YUV_A_1_FLD_C_CF_VA             REG_FLD(9, 0)
#define L2_Y2R_PARA_RGB_A_0_FLD_C_CF_GA             REG_FLD(9, 16)
...
#define L3_Y2R_PARA_YUV_A_0_FLD_C_CF_UA             REG_FLD(9, 16)
#define L3_Y2R_PARA_YUV_A_0_FLD_C_CF_YA                 REG_FLD(9, 0)
#define L3_Y2R_PARA_YUV_A_1_FLD_C_CF_VA                 REG_FLD(9, 0)
#define L3_Y2R_PARA_RGB_A_0_FLD_C_CF_GA                 REG_FLD(9, 16)
#define L3_Y2R_PARA_RGB_A_0_FLD_C_CF_RA                 REG_FLD(9, 0)
#define L3_Y2R_PARA_RGB_A_1_FLD_C_CF_BA             REG_FLD(9, 0)

#define DEBUG_MON_SEL_FLD_DBG_MON_SEL                                       REG_FLD(4, 0)
#define RDMA0_MEM_GMC_SETTING2_FLD_RDMA0_ISSUE_REQ_THRESHOLD    REG_FLD(8, 0)
#define RDMA1_MEM_GMC_SETTING2_FLD_RDMA1_ISSUE_REQ_THRESHOLD    REG_FLD(8, 0)
#define RDMA2_MEM_GMC_SETTING2_FLD_RDMA2_ISSUE_REQ_THRESHOLD    REG_FLD(8, 0)
#define RDMA3_MEM_GMC_SETTING2_FLD_RDMA3_ISSUE_REQ_THRESHOLD    REG_FLD(8, 0)
#define DUMMY_REG_FLD_OVERLAY_DUMMY                                         REG_FLD(32, 0)

#define FLOW_CTRL_DBG_FLD_UPD_REG                           REG_FLD(1, 31)
#define FLOW_CTRL_DBG_FLD_REG_UPDATE                        REG_FLD(1, 30)
#define FLOW_CTRL_DBG_FLD_CLR                                   REG_FLD(1, 29)
#define FLOW_CTRL_DBG_FLD_START                                 REG_FLD(1, 28)
#define FLOW_CTRL_DBG_FLD_RUNNING                           REG_FLD(1, 27)
#define FLOW_CTRL_DBG_FLD_FRAME_DONE                        REG_FLD(1, 26)
#define FLOW_CTRL_DBG_FLD_FRAME_UNDERRUN                REG_FLD(1, 25)
#define FLOW_CTRL_DBG_FLD_FRAME_SWRST_DONE          REG_FLD(1, 24)
#define FLOW_CTRL_DBG_FLD_FRAME_HWRST_DONE              REG_FLD(1, 23)
#define FLOW_CTRL_DBG_FLD_TRIG                                  REG_FLD(1, 21)
#define FLOW_CTRL_DBG_FLD_RST                                   REG_FLD(1, 20)
#define FLOW_CTRL_DBG_FLD_RDMA0_IDLE                        REG_FLD(1, 19)
#define FLOW_CTRL_DBG_FLD_RDMA1_IDLE                        REG_FLD(1, 18)
#define FLOW_CTRL_DBG_FLD_RDMA2_IDLE                        REG_FLD(1, 17)
#define FLOW_CTRL_DBG_FLD_RDMA3_IDLE                        REG_FLD(1, 16)
#define FLOW_CTRL_DBG_FLD_OUT_IDLE                              REG_FLD(1, 15)
#define FLOW_CTRL_DBG_FLD_OUT_READY                         REG_FLD(1, 13)
#define FLOW_CTRL_DBG_FLD_OUT_VALID                         REG_FLD(1, 12)
#define FLOW_CTRL_DBG_FLD_BLEND_IDLE                        REG_FLD(1, 11)
#define FLOW_CTRL_DBG_FLD_ADDCON_IDLE                       REG_FLD(1, 10)
#define FLOW_CTRL_DBG_FLD_FSM_STATE                         REG_FLD(10, 0)
...
#define RDMA1_DBG_FLD_RDMA1_SMI_GREQ                        REG_FLD(1, 29)
#define RDMA1_DBG_FLD_RDMA1_SMI_BUSY                        REG_FLD(1, 28)
#define RDMA1_DBG_FLD_RDMA1_OUT_VALID                       REG_FLD(1, 29)
#define RDMA1_DBG_FLD_RDMA1_OUT_READY                       REG_FLD(1, 28)
#define RDMA1_DBG_FLD_RDMA1_OUT_DATA                        REG_FLD(24, 4)
#define RDMA1_DBG_FLD_RDMA1_WRAM_RST_CS                 REG_FLD(3, 0)
#define RDMA1_DBG_FLD_RDMA1_LAYER_GREQ                          REG_FLD(1, 29)

#define RDMA2_DBG_FLD_RDMA2_SMI_GREQ                        REG_FLD(1, 29)
#define RDMA2_DBG_FLD_RDMA2_SMI_BUSY                        REG_FLD(1, 28)
#define RDMA2_DBG_FLD_RDMA2_OUT_VALID                       REG_FLD(1, 29)
#define RDMA2_DBG_FLD_RDMA2_OUT_READY                       REG_FLD(1, 28)
#define RDMA2_DBG_FLD_RDMA2_OUT_DATA                        REG_FLD(24, 4)
#define RDMA2_DBG_FLD_RDMA2_WRAM_RST_CS                     REG_FLD(3, 0)
#define RDMA2_DBG_FLD_RDMA2_LAYER_GREQ                          REG_FLD(1, 29)

#define RDMA3_DBG_FLD_RDMA3_SMI_GREQ                        REG_FLD(1, 29)
#define RDMA3_DBG_FLD_RDMA3_SMI_BUSY                        REG_FLD(1, 28)
#define RDMA3_DBG_FLD_RDMA3_OUT_VALID                       REG_FLD(1, 29)
#define RDMA3_DBG_FLD_RDMA3_OUT_READY                       REG_FLD(1, 28)
#define RDMA3_DBG_FLD_RDMA3_OUT_DATA                        REG_FLD(24, 4)
#define RDMA3_DBG_FLD_RDMA3_WRAM_RST_CS                     REG_FLD(3, 0)
#define RDMA3_DBG_FLD_RDMA3_LAYER_GREQ                          REG_FLD(1, 29)
