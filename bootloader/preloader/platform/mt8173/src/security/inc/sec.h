...
/* rpmb functionality */
extern int seclib_rpmb_mac_init(unsigned char *buf, unsigned int size);
extern int seclib_rpmb_mac_process(unsigned char *buf, unsigned int size);
extern int seclib_rpmb_mac_done(unsigned char *outmac, unsigned int *size);
extern int seclib_rpmb_mac_process_ex(void *h, unsigned char *buf, unsigned int size);

extern int seclib_get_random_data(unsigned char *data, unsigned int size);
#endif /* SEC_H */
